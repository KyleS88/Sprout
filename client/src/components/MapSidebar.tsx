...
const MapSidebar: React.FC<MySidebarProps> = (props) => {
    ...
    const addSymbol = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="icon-plus">
            <path d="M12 5v14M5 12h14"/>
        </svg>
    const trashSymbol = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="icon-trash">
            <path d="M3 6h18"/>
            <path d="M19 6l-1 14H6L5 6"/>
            <path d="M9 6V4h6v2"/>
            <path d="M10 11v6M14 11v6"/>
        </svg>
    const logoutSymbol = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" className="icon-logout">
